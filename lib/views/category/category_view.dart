...
//                         IconButton(
//                           onPressed: () {
//                             _showAddMeetingNoteDialog(context, meetingNoteProvider, channelProvider, categoryProvider);
//                           },
...
//                         ),
//                         IconButton(
//                           onPressed: () => categoryProvider.showAddCategoryDialog(context, channelId),
//                           icon: Icon(
//                             Icons.add,
...
//                           final categoryName = category['name'] ?? '카테고리 이름 없음';
//                           return Padding(
...
//                               onPressed: () => categoryProvider.selectCategory(categoryName),
...
//                 items: [
//                   const DropdownMenuItem(value: null, child: Text("카테고리 선택 안함")),
//                   ...categoryProvider.categories[channelProvider.selectedChannel]?.map((category) {
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              onTap: () {
                                setState(() {
                                  _expandedCategories[category['category_id']] =
                                      !(_expandedCategories[category['category_id']] ?? false);
                                });
                              },
                              child: ElevatedButton(
                                onPressed: () {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Icon(_expandedCategories[category['category_id']] == true
                                        ? Icons.expand_less
                                        : Icons.expand_more),
                                  ],
                                ),
                            ...
                            if (_expandedCategories[category['category_id']] == true)
                            ...categorizedMeetings[category['category_id']]?.map((meeting) {
